        ...
        <div class="info_rent">
          ...
          <v-card-subtitle id="subtitle">
            <v-row class="item_rent">
              <v-col sm="12" md="4">
                <v-row>
                  ...
                  <span v-if="game.min_players !== null">Players : {{ game.min_players }} to {{ game.max_players }}</span>
                  <span v-else> Players : 1 to 10 </span>
                </v-row>
              </v-col>
              <v-col sm="12" md="4">
                <v-row >
                  <img cover class="icon" :src="require(`../../assets/images/icon1.png`)"/>
              ...
              <v-col sm="12" md="4">
                <v-row>
                  <img cover class="icon" :src="require(`../../assets/images/icon2.png`)"/>
            ...
            <v-row class="item_rent">
              <v-col sm="12" md="4">
                <v-row>
                  <img cover class="icon" :src="require(`../../assets/images/004.png`)"/>
                  <span v-if="game.min_age!== null">Sweet Age : {{ game.age_min }} to 99</span>
                  <span v-else> Sweet Age : 6 to 99 </span>
                </v-row>
              </v-col>
              <v-col sm="12" md="4">
                <v-row>
                  <img cover class="icon" :src="require(`../../assets/images/019.png`)"/>
                  <span v-if="game.average_learning_complexity!== null">Complexity: {{ game.average_learning_complexity}} /5</span>
                  <span v-else> Complexity : 2/5 </span>
                </v-row>
              </v-col>
              <v-col sm="12" md="4">
                <v-row>
                  <img cover class="icon" :src="require(`../../assets/images/icon3.png`)"/>
...
.container_rent {
  ...
  border-radius: 5px;
  box-shadow: rgba(255, 129, 2, 0.25) 0px 30px 60px -12px inset, rgba(210, 90, 4, 0.3) 0px 18px 36px -18px inset;
  background-color: black !important;
